...
export default function ComponentPage({ params }: { params: { id: string } }) {
  ...
  const { data, component, componentCode, settingsEngine } = componentsMap[id as string];

  return (
    <div className="flex w-full flex-col items-start justify-start text-left max-w-6xl mx-auto">
      ...
      <div className="mt-4 w-full">
        ...
        <div className="col-span-12 space-y-6 px-4 lg:col-span-9">
          <div className="ml-4 mt-4 relative col-span-8 space-y-8 px-4 before:absolute before:-left-3 before:bottom-1 before:top-2 before:w-0.5 before:bg-gray-700">
